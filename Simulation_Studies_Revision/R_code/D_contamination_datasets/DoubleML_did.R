# DoubleML doubly-robust DiD (random-forest nuisances) benchmark for scenario "D_contamination".
# Run from inside R_code/D_contamination_datasets/  (the folder holding the
# linearity_degree=1/2/3 sub-folders written by DGPs/data_creation_D_contamination.py).
