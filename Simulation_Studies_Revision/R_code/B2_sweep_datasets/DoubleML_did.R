# DoubleML doubly-robust DiD (random-forest nuisances) benchmark for scenario "B2_sweep".
# Run from inside R_code/B2_sweep_datasets/  (the folder holding the
# linearity_degree=1/2/3 sub-folders written by DGPs/data_creation_B2_sweep.py).
