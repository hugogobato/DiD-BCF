# DoubleML doubly-robust DiD (random-forest nuisances) benchmark for scenario "B1_strong_confounder".
# Run from inside R_code/B1_strong_confounder_datasets/  (the folder holding the
# linearity_degree=1/2/3 sub-folders written by DGPs/data_creation_B1_strong_confounder.py).
