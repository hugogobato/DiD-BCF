# DoubleML doubly-robust DiD (random-forest nuisances) benchmark for scenario "B1_baseline".
# Run from inside R_code/B1_baseline_datasets/  (the folder holding the
# linearity_degree=1/2/3 sub-folders written by DGPs/data_creation_B1_baseline.py).
