...
main, installs requirements-colab.txt, adds this folder's src to sys.path,
runs the selected shard, resumes local checkpoints, and zips every artifact. Since a run creates five or more artifacts,
